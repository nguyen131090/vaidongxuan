...
//var_dump($this->tools);exit;
     ...
     * @return string
     */
    public function getUrl($file, array $params = [], $absolute = false)
    {
     ...
     * @return string
     */
    public function getPath($file, array $params = [])
    {
        $cacheFilePath = $this->getCacheFile($file, $params);
     ...
     * @return bool|string
     */
    protected function getCacheFile($file, array $params = [])
    {
     ...
     * @return string
     */
    protected function createUrl($filePath, $absolute = false)
    {
     ...
     * @return string
     */
    protected function createPath($filePath)
    {
     ...
     * @return string
     */
    protected function generateCacheFilePath($file, array $params = [])
    {
        $md5 = md5($file . serialize($params));
        //var_dump($file . serialize($params));exit;
       // $md5 = md5(rand(0, 9999));
        $arr = explode('/', $file);
        
        $hash = explode('.', $arr[count($arr) - 1])[0].'-'.$md5;
     ...
     */
    protected function createImage($file, array $params, $savePath)
    {
     ...
     * @param string $savePath
     */
    protected function makeDir($savePath)
    {
