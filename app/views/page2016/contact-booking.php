...
<div class="contain container-2 area-form amc-fix-title-text">
    ...
    <div class="amc-column p-0">
        <div class="text p-0 pt-txt-0 pb-txt-40 text-center text-top-form">
            ...
            <?
              //  include_once '_form_contact_tour.php';
            ?>
...
?>
    ...
    <div class="amc-bg-color-f7f7f7 area-4 pb-txt-40">
        <table id="" class="form">
            <tr>
                <td colspan="2">
