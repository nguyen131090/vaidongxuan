...
<table id="tbl-contact" class="form">
        ...
        <tr>
            ...
            <td colspan="2" class="info-error">
                ...
                <div class="float-left amc-col amc-col-1 col-xs-4 col-sm-8 col-md-8">
        ...
        <tr>
            <td colspan="2">
                <div class="float-left amc-col amc-col-2 col-xs-12 col-sm-3 col-md-3 col-fix-align fix-error-label">
                    <span class="fix-middle-text text-label">Sujet <span class="violet">*</span></span>
                </div>
                <div class="float-left amc-col amc-col-2 col-xs-12 col-sm-6 col-md-6">
                        <?=$form->field($model, 'subjet', [
                                'inputOptions'=>['class'=>'fix-arrow input_full'],
