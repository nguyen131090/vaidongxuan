...
<div class="entry-body-entry container-flud mb-60 responsive-entry-body">
    <div class="column pourquoi mt-0">
        <h2 class="title-pourquoi mt-txt-0 mb-txt-40">Pourquoi nous choisir pour votre voyage au Vietnam</h2>   
    ...
    <div class="column preparer-voyage mt-60">
        <h2 class="mt-0 mb-txt-40">Préparer votre voyage au Vietnam</h2>
        ...
        <a href="https://www.amica-travel.com/vietnam/informations-pratiques" style="color: #e35429;" class="btn-amica-basic btn-amica-basic-1 mt-txt-40 mb-0" data-analytics="on" data-analytics-category="country_page" data-analytics-action="info_section" data-analytics-label="cta_c_infos">Voir toutes nos informations pratiques sur le Vietnam</a>
