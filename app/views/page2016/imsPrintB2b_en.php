...
<html lang="fr">
    ...
    <body style="font-family:Bell MT;  font-size:11pt;">
                                    ...
                                    if (file_exists($dir)) {
                                        ...
                                        foreach ($photos as $pt) :
                                            ...
                                            <a data-val='<?=$pt?>' data-img='<?= DIR . 'upload/banner_2_devis/b2b/banner_new/'.$pt; ?>' href="#">
                                                <img alt="" width="" height="" src="<?= DIR ?>timthumb.php?src=<?= DIR . 'upload/banner_2_devis/b2b/banner_new/' .$pt; ?>&w=180&h=160&zc=1"/>
												<p class="tt"><?= str_replace(['jpg','png'],'',preg_replace('/[^a-z]/i',' ', $pt));?></p>
                                            </a>
                                            <?
                                        endforeach;
                                    }
                                    ...
                                    if (file_exists($dir)) {
                                        ...
                                        foreach ($photos as $pt) :
                                            ...
                                            echo "<li>
                                                ...
                                                <img alt='' class='img-devis' style='width: 150px' src='".DIR."timthumb.php?src=".DIR."upload/image_devis_secretindochina/$pt&w=185&h=90'>
        ...
        <div style="width:800px; margin:auto;">
            ...
            <p id='loading' style='display:none;'>Please Wait <img alt="" src='<?= DIR ?>assets/img/devis-ims/loading.gif'/></p>
            <div class="option-devis">
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <img alt="" class="img-devis" style="width: 145px" src='<?= DIR ?>assets/img/devis-ims/secretindochina/Devis_B2b_En_New.png'>
                ...
                <table style="margin: 0;padding: 0;border: none;border-collapse: collapse;width: 268pt;">
                    <tr>
                        ...
                        <td style="text-align: left; padding: 0;margin: 0;width: 130px">
                            <img alt="" width="130" height="130" src='<?= $theProduct['createdBy']['image'] ?>'/>
                        </td>
                    </tr>
                </table>
            </div>
            <h2 style="border-bottom:1px solid rgb(228,58,146); color:rgb(228,58,146); font-size: 30px;">Front page | Trang bìa</h2>
...
?>
            ...
            <h2 style="font-family: Bell MT;border-bottom:1px solid rgb(228,58,146); color:rgb(228,58,146); font-size: 13pt; font-variant: small-caps;">Program in brief</h2>
            <table border="1" id='devis-table-programe' style='margin: 0; padding: 0; width: 100%;border-collapse: collapse;border-color: rgb(191,191,191);'>
                ...
                <th style="text-align:center;border-bottom: 1px solid;border-right: 1px solid; border-color: rgb(191,191,191);width: 10%; padding: 2mm 1mm 2mm 0;"><h3 style="font-family:Bell MT;  font-size:11pt; color:rgb(228,58,146); margin:0;">Day</h3></th>
                ...
                <th style="text-align:center;border-bottom: 1px solid;border-right: 1px solid;border-color: rgb(191,191,191);width:  39.1%;"><h3 style="font-family:Bell MT;  font-size:11pt; color:rgb(228,58,146); margin:0;padding-right: 1mm;">Itinerary</h3></th>
                <th style="text-align:center;border-bottom: 1px solid;border-right: 1px solid;border-color: rgb(191,191,191);width: 22.6%;"><h3 style="font-family:Bell MT;  font-size:11pt; color:rgb(228,58,146); margin:0;padding-right: 1mm;">Accompaniment</h3></th>
                <th style="text-align:center;border-bottom: 1px solid;border-right: 1px solid;border-color: rgb(191,191,191);width: 17%;"><h3 style="font-family:Bell MT;  font-size:11pt; color:rgb(228,58,146); margin:0;">Meals</h3></th>
                </tr>
                </thead>
                <?
                $cnt = 0;
...
//$ngay_fr = array('Lundi', 'Mardi', 'Mercredi', 'Jeudi', 'Vendredi', 'Samedi', 'Dimanche');
            ...
            <h2 style="font-family: Bell MT; border-bottom:1px solid rgb(228,58,146); color:rgb(228,58,146); font-size: 13pt; font-variant: small-caps;">Program in detail</h2>
                            ...
                            foreach ($theProduct['days'] as $ng) {
                                if ($ng['id'] == $di) {
                                  ...
                                  //  $ngay = str_replace($ngay_en, $ngay_fr, $ngay);
                                    ...
                                    ?>
                            <h4 style="font-size:11pt;font-family:Bell MT;font-variant: small-caps;">Day <?= $cnt ?> - <?= $ngay ?><span style=""> | <?= $ng['name'] ?> (<?= implode(', ',str_split($ng['meals'])) ?>)</span></h4>
            ...
            <h2 style="font-family: Bell MT; border-bottom:1px solid rgb(228,58,146); color:rgb(228,58,146); font-size: 13pt; font-variant: small-caps;">Accommodations selection </h2>
            <div id='devis-table-tarif'>
                ...
                <th style="text-align:center;padding-left: 2mm;padding-right: 1mm;border-bottom: 1px solid rgb(191,191,191); border-right: 1px solid rgb(191,191,191); width: 30%;"><h3 style="background: none;font-family:Bell MT; color:rgb(228,58,146); font-size:11pt;">Hotel/Resort & Website</h3></th>
                <th style="text-align:center;padding-left: 2mm;padding-right: 1mm;border-bottom: 1px solid rgb(191,191,191); border-right: 1px solid rgb(191,191,191); width: 18%;"><h3 style="background: none;font-family:Bell MT; color:rgb(228,58,146); font-size:11pt;">Nights Spent</h3></th >
                <th style="text-align:center;padding-left: 2mm;border-bottom: 1px solid rgb(191,191,191);border-right: 1px solid rgb(191,191,191); width: 30%;font-size:11pt;"><h3 style="background: none;font-family:Bell MT; color:rgb(228,58,146); font-size:11pt;">Room Category</h3></th>
                </tr>';
                        }
...
<td style="text-align:center;border-bottom: 1px solid rgb(191,191,191);border-right: 1px solid rgb(191,191,191); font-family:Bell MT;  font-size:11pt; padding: 5pt 2mm;" class="a-href"><span style="background-color: none;">' . trim($line[2]) . '</span></td></tr>';
            ...
            <h2 style="font-family: Bell MT; border-bottom:1px solid rgb(228,58,146); color:rgb(228,58,146); font-size: 13pt; font-variant: small-caps;">Tour rates </h2>
            <div id='devis-condition'>
                <p style="font-family:Bell MT; font-size:11pt; line-height: 20pt;">
                     Valid until the ....................... . Rates are <b>nett</b>, in <b>USD/pax</b>, exclude bank transfer fee. Double or Twin shared basis.
                </p>
...
//         });
    ...
    jQuery(function($) {
          ...
          $('.test a').click(function() {
            $('#image-header').html('<img alt="" data-val="'+$(this).data('val')+'" width="850" src="'+$(this).data('img')+'"/>');
            disablePopup();
        });
