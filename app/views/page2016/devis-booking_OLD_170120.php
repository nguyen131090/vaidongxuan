        ...
        <table id="" class="form">
            ...
            <tr>
                <td colspan="2">
                    <div class="float-left w-100 p-0">
                        ...
                        <p class="amc-text-question amc-latolatin-semibold mt-25 mb-5 amc-vouspartez amc-opt-2">Les participants</p>
            ...
            <tr>
                <td colspan="2">
                    ...
                    <div class="float-left pl-5">
                        <p class="amc-text-question amc-latolatin-semibold mt-25 mb-10"><?= Yii::$app->params['questions_form']['deretourDate'][0] ?> <span class="amc-color-b1b1b1 amc-latolatin-regular"><?= Yii::$app->params['questions_form']['deretourDate'][1] ?></span></p>

                        <div class="float-left amc-arrow p-0" style="min-width: 116px;">
                            <?=$form->field($model, 'deretourDate',['inputOptions'=>['class'=>'amc-iput-focus input-width-196 input-deretourDate datepicker','placeholder'=>'Choisissez la date']])?>     
                        </div>
                    </div>
                </td>
            </tr>
            ...
            <tr>
                <td colspan="2">
                    ...
                    <div class="float-left howTicket">
                        <p class="amc-text-question amc-latolatin-semibold mt-txt-40 mb-5"><?= Yii::$app->params['questions_form']['howTicket'][0] ?></p>
                            
                        <?=$form->field($model, 'howTicket', ['inputOptions' => ['class' => '']])->radioList(
                                    ['Oui' => 'Oui', 'Non mais je souhaite être accompagné pour l\'achat de mes billets' => 'Non mais je souhaite être accompagné pour l\'achat de mes billets' ,'Non' => 'Non']
                            )?>
                    </div>  
                    <div class="float-left w-100 ticketDetail ticket-plus p-0 pb-10">
                          <p class="amc-text-question amc-latolatin-semibold mt-25 mb-10"><?= Yii::$app->params['questions_form']['ticketDetail'][0] ?></p>
                      
                                    
                                      <?=$form->field($model, 'ticketDetail', [
                        'inputOptions'=>['class'=>'input_full', 'rows'=>4]])->textArea();?>  
                    </div>
<!--                    <div class="float-left help-ticket ticket-plus p-0">
                        <p class="amc-text-question amc-latolatin-semibold mt-25 mb-5">Souhaitez-vous être accompagné pour l’achat de vos billets internationnaux ?</p>
                      
                        <?//=$form->field($model, 'helpTicket', ['inputOptions' => ['class' => '']])->radioList(
                         //           ['Oui' => 'Oui', 'Non' => 'Non']
                       // )?>
                    </div>-->
                </td>
        ...
        <table id="" class="form">
            ...
            <tr>
                <td colspan="2">
                    ...
                    <div class="float-left">
                        <p class="amc-text-question amc-latolatin-semibold mt-txt-40 mb-5"><?= Yii::$app->params['questions_form']['hotelTypes'][0] ?></p>
                ...
                <td colspan="2">
                    <div class="float-left w-100">
                        <p class="amc-text-question amc-latolatin-semibold mt-txt-40 mb-10">
                             <?= Yii::$app->params['questions_form']['desSites'][0] ?>
                            
                        </p>
                        
                        <?=$form->field($model, 'desSites', [
                            'inputOptions'=>['class'=>'input_full', 'rows'=>1,'style'=>'height: 42px; padding: 5px 10px;'],
                            ])->textArea()?>
                    </div>  
                </td>
            </tr>
            ...
            <tr>
                <td colspan="2">
                    <p class="amc-text-question amc-latolatin-semibold mt-txt-40 mb-10"><?= Yii::$app->params['questions_form']['mealsIncluded'][0] ?></p>
                    <div class="float-left w-100">
    ...
    <div class="amc-bg-color-f7f7f7 area-3 pb-40">
        <table id="" class="form">
            <tr>
                <td colspan="2">
            ...
            <tr>
                <td colspan="2">
                    <div class="float-left pl-0 pr-5">
                        <p class="amc-text-question amc-latolatin-semibold mt-25 mb-10"><?= Yii::$app->params['questions_form']['fname'][0] ?> <span class="amc-color-e75925"><?= Yii::$app->params['questions_form']['fname'][2] ?></span></p>
                     ...
                     <div class="float-left pl-20">
                        <p class="amc-text-question amc-latolatin-semibold mt-25 mb-10"><?= Yii::$app->params['questions_form']['lname'][0] ?> <span class="amc-color-e75925"><?= Yii::$app->params['questions_form']['lname'][2] ?></span></p>
            ...
            <tr>
                <td colspan="2">
                    ...
                    <div class="float-left pr-5">
                        ...
                        <div class="float-left p-0" style="">
                           <?=$form->field($model, 'email', ['inputOptions'=>['class'=>'input-width-340 disablecopypage','placeholder'=>'email@domain.com']]) ?>
                                
                        </div>
                    </div>
                    <div class="float-left pl-20">
                        <p class="amc-text-question amc-latolatin-semibold mt-txt-40 mb-10"><?= Yii::$app->params['questions_form']['country'][0] ?> <span class="amc-color-e75925"><?= Yii::$app->params['questions_form']['country'][2] ?></span></p>
