...
require_once(Yii::getAlias('@webroot').'/helpers/hxTextile.php');
    ...
    if (file_exists($dir)) {
        ...
        foreach ($photos as $pt) {
        	...
        	echo "<li>
                    ...
                    <img alt='' class='img-devis' style='width: 150px' src='".DIR."upload/banner_date_tour_devis/$folderName/$pt'>
...
<html lang="fr">
    ...
    <body style="font-family:Calibri; font-size:9pt;">
        <div style="width:800px; margin:auto;">
                    ...
                    <? foreach ($temArr as $key => $value) : ?>
                        ...
                        <h2><?=$key ?></h2>
                          <? foreach ($value as $ki => $vi) :?>
                              <li>
                                    <p><?=$vi['name'] ?></p>
                                    <img alt="" class="img-devis" style="width: 70px" src='<?= DIR ?>assets/img/thumb/<?=$vi['thumb'] ?>.JPG'>
                                       ...
                                       $photos = FileHelper::findFiles($value, ['recursive' => false, 'only' => ['*.jpg','*.png']]);
                                        foreach ($photos as $pt) :
                                            ...
                                            echo "<li>
                                                ...
                                                <img alt='' class='img-devis' style='width: 150px' src='".DIR."timthumb.php?src=".DIR."upload/banner_2_devis/".$pt."&w=150&h=60&zc=1'>
                                   ...
                                   // $dir = '/var/www/www.amica-travel.com/upload/image_devis_secretindochina/';
                                    ...
                                    if (file_exists($dir)) {
                                        ...
                                        foreach ($photos as $pt) :
                                            ...
                                            echo "<li>
                                                <p>".str_replace(['-', '.png', '.jpg'], [' ', '', ''], $pt)."</p>
                                                <img alt='' class='img-devis' style='width: 150px' src='".DIR."timthumb.php?src=".DIR."upload/banner_2_devis/image_tableau/".$pt."&w=150&h=60&zc=1'>
                                                <input type='checkbox' value='".$pt."'/>
                                                </li>";
            ...
            <div id='sale-detail'>
                <p style='margin: 0; padding: 0;font-size: 9pt;'><img alt="" width='130' height='130' src='<?= $theProduct['createdBy']['image'] ?>'/></p>
                <br>
...
//$ngay_fr = array('Lundi', 'Mardi', 'Mercredi', 'Jeudi', 'Vendredi', 'Samedi', 'Dimanche');
            ...
            <table width="600" cellspacing="0" cellpadding="0" id='tableau-devis' class="simple" border="0" style="width: 600px; margin: 0; padding: 0;border-collapse: collapse; border-color: #BD3920;">  
                <thead>
                    <tr>
                        <th valign="bottom" colspan="4" width="600" height="50" style="text-align:left; padding: 0;"><img alt="" align="left" width="820" src="<?=DIR?>assets/img/head-table-title.jpg"></th>
                                   ...
                                   // $dir = '/var/www/www.amica-travel.com/upload/image_devis_secretindochina/';
                                    ...
                                    if (file_exists($dir)) {
                                        ...
                                        foreach ($photos as $pt) :
                                            ...
                                            echo "<li>
                                                <p>".str_replace(['-', '.png', '.jpg'], [' ', '', ''], $pt)."</p>
                                                <img alt='' class='img-devis' style='width: 150px' src='".DIR."timthumb.php?src=".DIR."upload/img-devis/footer/".$pt."&w=150&h=60&zc=1'>
                                                <input type='checkbox' value='".$pt."'/>
                                                </li>";
