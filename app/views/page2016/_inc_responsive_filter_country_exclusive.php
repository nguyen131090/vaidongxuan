    ...
    <div class="column amc-column">
        ...
        <div class="search-form quick-search">
            <form class="form-search horizontal search-excl-form">
                                <div class="cs-select destination search-destination destination-mn-2" style="display: none;">
                                    <span class="cs-placeholder"> <span class="input-text ml-10">Destination(s)</span><span class="icon-right"></span></span>
                                        <div class="cs-options" style="">
                                            <ul>
                                               <li class="<?= SEG1 == 'vietnam' ? 'active' : ''?>" data-option="" data-value="vietnam"><span class="icon-check"></span><span class="text-option">Vietnam</span></li>
                                                <li class="<?= SEG1 == 'laos' ? 'active' : ''?>" data-option="" data-value="laos"><span class="icon-check"></span><span class="text-option">Laos</span></li>
                                                <li class="<?= SEG1 == 'cambodge' ? 'active' : ''?>" data-option="" data-value="cambodge"><span class="icon-check"></span><span class="text-option">Cambodge</span></li>
                                                <li class="<?= SEG1 == 'birmanie' ? 'active' : ''?>" data-option="" data-value="birmanie"><span class="icon-check"></span><span class="text-option">Birmanie</span></li>
                                            </ul>
                                        </div>
                                ...
                                <div class="cs-select type-de-voyage search-type search-envies votre-envie-mn-2">
                                    <span class="cs-placeholder"> <span class="input-text ml-10">Votre envie du moment</span><span class="icon-right"></span></span>
                                        <div class="cs-options" style="">
