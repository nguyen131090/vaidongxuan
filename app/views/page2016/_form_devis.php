		...
		<table id="tbl-contact" class="form">
			<tr>
                       ...
                       <tr>
                           ...
                           <td colspan="2" style="padding-top: 42px;">
                                <div class="float-left amc-col amc-col-2 col-xs-12 col-sm-12 col-md-12">
                                    <img alt="" src="<?=DIR?>assets/img/banner-promo-devis.jpg">
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
                                <h2 class="text-area text-area-1" style="background: none; margin-top: 4px;">Vos coordonnées</h2>
                            </td>
                        </tr>
            ...
            <td colspan="2" class="address">
                ...
                <div class="float-left amc-col amc-col-2 col-xs-12 col-sm-1 col-md-1" style="min-width: 125px;">
                        ...
                        <tr>
                            <td colspan="2">
                                <h2 class="text-area text-area-2">votre projet</h2>
                            </td>
                        </tr>
			...
			<tr>
                            <td colspan="2">
                                <div class="float-left amc-col amc-col-2 col-xs-12 col-sm-3 col-md-3 col-fix-align fix-error-label" style="margin: 10px 0;">    
                                    <span class="text-label">Destination(s) <span class="violet">*</span></span>
                                </div>
                                <div class="float-left amc-col amc-col-2 col-xs-12 col-sm-6 col-md-6" style="margin: 10px 0;">
                                    <?=$form->field($model, 'countriesToVisit')->radioList(Yii::$app->params['formCountriesToVisitList']) ?>
                                </div> 
                                <div class="float-left amc-col amc-col-2 col-xs-12 col-sm-3 col-md-3 multi-pays fix-select-multi-pays" style="display:<?//=$model->countriesToVisit == 'Multipays' ? 'auto' : 'none'?>">
                                    <?=$form->field($model, 'multipays',['inputOptions'=>['class'=>'fix-arrow']])->dropDownList(Yii::$app->params['formMulti-pays'], ['prompt'=>'Sélectionner']) ?>
                                </div>      
                            </td>
			</tr>
            <tr>
                            <td colspan="2">
                                <div class="float-left amc-col amc-col-2 col-xs-12 col-sm-3 col-md-3 col-fix-align fix-col-left fix-error-label" style="min-height: 135px;">
                                    <span class="middle-text text-label">Décrivez votre projet, votre vision du voyage et de quelle façon vous souhaitez découvrir notre pays <span class="violet">*</span></span>
                                </div>
			...
			<tr>
                            <td colspan="2" class="td-how-ticket">
                                ...
                                <div class="ticketDetail ticket-plus amc-col amc-col-2 col-xs-12 col-sm-9 col-md-9 float-right">
                                    <label>En savoir plus :</label>
                                      <?=$form->field($model, 'ticketDetail', [
                        'inputOptions'=>['class'=>'input_full', 'rows'=>4]])->textArea();?>  
                                </div>
                                 <div class="help-ticket ticket-plus amc-col amc-col-2 col-xs-12 col-sm-9 col-md-9 float-right">
			...
			<!-- Question -->
				...
				<div class="float-left amc-col amc-col-2 col-xs-12 col-sm-9 col-md-9">
                        ...
                        <tr>
                            <td colspan="2">
                                <h2 class="text-area text-area-3">pour mieux vous connaitre</h2>
                            </td>
                        </tr>
			...
			<tr>
                        ...
                        <tr>
                            <td colspan="2">
                                <h2 class="text-area text-area-4">convenir d’un rdv téléphonique</h2>
                            </td>
                        </tr>    
                            ...
                            <td colspan="2">
                                ...
                                <div class="float-left amc-col amc-col-2 col-xs-12 col-sm-9 col-md-9">
                                    <div id="radio-rdv">
                                        ...
                                        <span>Pouvons-nous convenir d’un entretien téléphonique ?</span>  <br>
                                                    <?=
			...
			<tr class="rdv" style="display:<?=$model->callback == 'Oui' ? 'auto' : 'none'?>">
                        ...
                        <tr class="rdv" style="display:<?=$model->callback == 'Oui' ? 'auto' : 'none'?>">
                            <td colspan="2">
                                <div class="float-left amc-col amc-col-2 col-xs-12 col-sm-3 col-md-3 col-fix-align field-devisform-calldate">
...
$utcOKDate = new DateTime('tomorrow');
		...
		<tr class="new-rdv rdv">
            ...
            <td class="float-left amc-col col-sx-9 col-sm-9 col-md-9 col-lg-9" style="padding-bottom: 20px;">
