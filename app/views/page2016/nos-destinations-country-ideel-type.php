...
?>
    <div class="contain container-1">
        <? if (isset($theCountryType[0]->model->photos)) : ?>
            <?
            $banner = '';
            foreach ($theCountryType[0]->model->photos as $key => $value) {
    ...
    <div class="container-2 amc-menu-tab menu-tab responsive-menu-tab">
        <div class="scroll-menu-tab">
            <div class="amc-column column">
                <ul>
                    <li  class="<?= !SEG2 ? 'active' : '' ?>"><a href="<?=DIR.SEG1 ?>" data-analytics="on" data-analytics-category="itineraries_cat_page" data-analytics-action="submenu_section" data-analytics-label="link_country"><?='Voyage '. (SEG1 == 'birmanie' ? 'en ' : 'au '). ucfirst(SEG1)?></a></li>
                    <li class="<?= SEG2 == 'itineraire' ? 'active' : '' ?>"><a href="<?=DIR.SEG1 ?>/itineraire" data-analytics="on" data-analytics-category="itineraries_cat_page" data-analytics-action="submenu_section" data-analytics-label="link_c_itineraries">Idées de voyage</a></li>
                    <? if(SEG1 !== 'birmanie'){?>
                    <li class="<?= SEG2 == 'formules' ? 'active' : '' ?>"><a href="<?=DIR.SEG1 ?>/formules" data-analytics="on" data-analytics-category="itineraries_cat_page" data-analytics-action="submenu_section" data-analytics-label="link_c_secrets">Formules d'Amica</a></li>
                    <? } ?>
                    <li  class="<?= SEG2 == 'visiter' ? 'active' : '' ?>"><a href="<?=DIR.SEG1.'/visiter' ?>" data-analytics="on" data-analytics-category="itineraries_cat_page" data-analytics-action="submenu_section" data-analytics-label="link_c_cities">Sites à visiter</a></li>
                    <li class="<?= SEG2 == 'informations-pratiques' ? 'active' : '' ?>"><a href="<?=DIR.SEG1 ?>/informations-pratiques" data-analytics="on" data-analytics-category="itineraries_cat_page" data-analytics-action="submenu_section" data-analytics-label="link_c_infos">Infos pratiques</a></li>
                    <li class="<?= SEG2 == 'guide' ? 'active' : '' ?>"><a href="<?=DIR.SEG1 ?>/guide" data-analytics="on" data-analytics-category="itineraries_cat_page" data-analytics-action="submenu_section" data-analytics-label="link_c_guide">Guide culturel</a></li>
                </ul>
            </div>
        </div>    
    </div>
            ...
            <div class="rows row-1 mt-0">
                ...
                <div class="amc-col amc-col-2 <?=SEG1?> mr-10 d-none d-sm-none d-lg-block">
                    ...
                    <div class="area-1 fix-area mt-25 mb-0">
                        ...
                        <span data-title="<?= base64_encode(DIR.'devis') ?>" class="pugjd btn-contact btn-amica-basic btn-amica-basic-2" data-analytics="on" data-analytics-category="itineraries_cat_page" data-analytics-action="quote_section" data-analytics-label="cta_devis">Demander un devis</span>
                    </div>
                    ...
                    <div id="programes-load" class="getcontent">
                        ...
                        <div class="amc-row-order-by">
                            ...
                            <div class="amc-opt-filter amc-ajax-order-by">
                                <span class="amc-text" data-analytics="on" data-analytics-category="itineraries_cat_page" data-analytics-action="sortby_section" data-analytics-label="select_sortby"><?= Yii::$app->request->get('orderby') == Null ? 'Popularité' : $amc_text_opt[Yii::$app->request->get('orderby')] ?></span>
...
//                            }
                                ...
                                <div class="amc-area-prog-btn">
                                    <div>
                                        ...
                                        <div class="see-more mt-25">
                                            <span class="btn-submit ajax-see-more btn-amica-basic btn-amica-basic-1" data-get="<?= 'country=' . $country . '&type=' . $type . '&length=' . $length . '&region=' . $region . '&orderby=' . $orderby ?>" data-seemore="<?= (($page + 1) * 12) ?>" data-value='<?= count($theEntries) ?>' data-page="<?= $page + 1 ?>" data-analytics="on" data-analytics-category="itineraries_cat_page" data-analytics-action="list_section" data-analytics-label="cta_more">Plus de circuits</span>
                                        </div>
                ...
                <div id="text-content" class="iti p-0 mr-xl-2 mr-lg-2 mr-sm-0 entry-content">
                    <span class="tt tt-seo <?= SEG2 ?> p-0">En savoir plus sur "<?= $theCountryType[0]->model->seo->h1 ?>"</span>
