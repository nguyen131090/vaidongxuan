        ...
        <div class="area-filter fix-banner-top">
            ...
            <span class="fil-background"></span>
             <? if($theCountryType[0]->model->seo != NULL){ ?>
                <h1 style="bottom: 2rem;" class="tt-title tt-fontsize-45 tt-latolatin-bold tt-color-white tt-custom"><?= $theCountryType[0]->model->seo->h1 ?></h1>
            <? }else{ ?>
                <h1 style="bottom: 2rem;" class="tt-title tt-fontsize-45 tt-latolatin-bold tt-color-white tt-custom"><?= $theCountryType[0]->title ?></h1>
            <? } ?>    
