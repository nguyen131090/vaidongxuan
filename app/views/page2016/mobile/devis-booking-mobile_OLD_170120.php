        ...
        <div id="step-2" class="steps step-2">
            <div class="field-form">
                <table id="tbl-form-tour" class="tbl-form">
                    ...
                    <tr>
                        <td class="" colspan="2">
                            <p style="padding-top: 2.25rem;" class="amc-text-label amc-tt-latolatin-semibold m-0 pt-50"><?= Yii::$app->params['questions_form']['hotelTypes'][0] ?></p>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
...
<!--                    <tr>
                    ...
                    <tr>
                        <td colspan="2" class="<?= empty($theProgram) ? 'hidden' : ''?>">
                            
                            <p style="padding-top: 1rem;" class="amc-text-label amc-tt-latolatin-semibold m-0 pt-25"><?= Yii::$app->params['questions_form']['extension'][0] ?> </p>
                            <p class="m-0 amc-color-949494 amc-tt-fontsize-28 mt-10"><?= Yii::$app->params['questions_form']['extension'][1] ?></p>
        ...
        <div id="step-3" class="steps step-3">
            ...
            <div class="mt-25" style="padding: 0 1.6rem;">
                <table id="tbl-form-tour" class="tbl-form">
                    <tr>
                        <td colspan="2">
