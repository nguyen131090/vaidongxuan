...
<div class="contain container-2 non-area-form">
    <div class="column">
        <div class="row-content top-tour">
            ...
            <ul class="features-tour" style="width: 100%;">
                <? if(isset($theEntry->data->countries)) :?>
                    <li class="posi countries" style="<?= $theEntry->model->days == 0 ? 'width: 48%;' : '' ?>">
                         <img data-src="/assets/img/page2016/posi.png" alt="">
                         <span>
                         <?php
                            $i= 0;
                ...
                <? } ?>
                <li style="<?= $theEntry->model->days == 0 ? 'width: 48%;' : '' ?>" class="tour-type tt-<?= $theEntry->cat->category_id?> tt-latolatin-bold">
...
<!--            <div class="galeries-slider">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <img alt="<?//= $v->description?>"
                                    data-src="/thumb/660/440/1/80<?//=$v->image?> 450w, <?//=$v->image?>" 
            ...
            <button data-title="<?= base64_encode(DIR.URI.'/form') ?>" class="btn-devis tt-latolatin-bold tt-fontsize-32 pugjd">Personnaliser ce voyage</button>
        </div>

        <div class="row-content tour-body">
            <!-- menu for content tour -->
            <? 
                preg_match('/Jour 1/', $theEntry->description, $matches);
                
                if($theEntry->description != '' && $matches != NULL ){ ?>
            <div class="menu-content full-width">
                <div class="menu-slider swiper-container">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide active"><span data-scroll = 'itineraire'>Itinéraire</span></div>
                        <div class="swiper-slide"><span data-scroll = 'esprit'>Esprit</span></div>
                        <? if($theEntry->description != ''){ ?>
                        <div class="swiper-slide"><span data-scroll = 'tour-detail'>Descriptif du programme</span></div>
                        <? } ?>
                        <? if($theProgram) : ?>
                        <div class="swiper-slide"><span data-scroll = 'formules-options'>Formules en option</span></div>
                        <? endif; ?>
                        <div class="swiper-slide"><span data-scroll = 'comment-combien'>Quand comment & combien</span></div>
                    </div>
            ...
            <? } ?>
                ...
                <div class="price-tour item-tour-content mb-0 mt-80" id="budget-voyage">
                    <p class="title-price sub-title-page tt-latolatin-bold tt-fontsize-40 tt-color-e65925">Prix</p>
                    <?=$theEntry->data->price ?>
                </div>
                <? endif; ?>
                <? 
                ...
                <div id="tour-detail" class="item-tour-content">
                    <p class="title-price sub-title-page tt-latolatin-bold tt-fontsize-40 tt-color-e65925">DESCRIPTIF DU PROGRAMME</p>
                    <?php
                ...
                <div class="item-tour-content" id="formules-options">
                    <p class="sub-title-page tt-latolatin-bold tt-color-e65925 tt-fontsize-40">FORMULES EN OPTION</p>
                        ...
                        <div class="swiper-wrapper">
                            ...
                            $v = $value->photosArray['banner'][0]; ?>
                                <img alt="<?= $v->description?>"
                                        ...
                                        class="banner-img lazyload" />
                            <? endif; ?>
                            <p class="title tt-latolatin-regular tt-fontsize-32"><?= isset($value->model->title) ? str_replace('|','',$value->model->title) : ''?></p>
                            </div>
                            <? endforeach; ?>
                        </div>
                    </div>
...
<button data-title="<?= base64_encode(DIR.URI.'/form') ?>" class="btn-devis tt-latolatin-bold tt-fontsize-32 ui-link ui-footer-fixed pugjd" data-position='fixed' data-ajax="false">
    <span>Personnaliser ce voyage</span>
</button>
