        ...
        <div id="step-3" class="steps step-3">
            <div class="field-form">
                <table id="tbl-form-tour" class="tbl-form">
                    ...
                    <tr>
                        <td class="" colspan="2">
                             <p class="amc-text-label amc-tt-latolatin-semibold m-0 amc-lineheight-fs32 pt-25"><?= Yii::$app->params['questions_form']['country-only-devis'][0] ?> <span class="amc-color-e75925"><?= Yii::$app->params['questions_form']['country-only-devis'][2] ?></span></p>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2" class="amc-fix-arrow">
