...
<? $this->registerJsFile('/assets/js/mobile/fix-banner-top.js', ['depends' => 'app\assets\AppAsset', 'position' => $this::POS_END]); ?>
 ...
 <?php $this->registerCssFile('/assets/css/mobile/improvisez.css',['depends' => 'app\assets\AppAsset', 'position' => $this::POS_END]) ?>
...
<div class="contain container-3">
    <div class="column">
        ...
        <div class="rows row-1 content tt-fontsize-32 tt-latolatin-regular">
            
           <?
             //str_replace('<p>&nbsp;</p>', ' ', preg_replace( '/style=(["\'])[^\1]*?\1/i', '', $theEntry->model->content, -1 ));
            $item_content = explode('<hr />', str_replace('<p>&nbsp;</p>', ' ', preg_replace( '/style=(["\'])[^\1]*?\1/i', '', $theEntry->model->content, -1 )));
            echo $item_content[0];
...
<div class="contain container-4 contain-background-ededed">
    <div class="column">
        ...
        <span class="space space-70"></span>
         <div class="rows row-2 content tt-fontsize-32 tt-latolatin-regular">
...
<div class="contain container-5">
    <div class="column">
        <span class="space space-50"></span>
        <div class="rows row-1 content tt-fontsize-32 tt-latolatin-regular tt-align-center">
...
<div class="contain container-6 contain-background-ededed">
    <div class="column">
        ...
        <span class="space space-50"></span>
        <p data-title="<?= base64_encode(DIR.'devis')?>" class="pugjd btn-link btn-link-1 tt-title tt-fontsize-32 tt-latolatin-bold tt-color-e65925"><span>Faites-nous savoir vos attentes</span></p>
        <span class="space space-80"></span>
