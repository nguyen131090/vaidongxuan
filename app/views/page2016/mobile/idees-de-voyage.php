...
<div class="contain container-2">
    <div class="column">
        ...
        <? if($theEntry->model->seo != NULL){ ?>
                <h1 class="tt-title tt-fontsize-45 tt-latolatin-bold tt-color-000000 tt-align-left tt-custom"><?= $theEntry->model->seo->h1 ?></h1>
            <? }else{ ?>
                <h1 class="tt-title tt-fontsize-45 tt-latolatin-bold tt-color-000000 tt-align-left tt-custom"><?= $theEntry->title ?></h1>
            <? } ?>    
...
<!--        <span class="space space-80"></span>-->
        ...
        <div class="all-tour ajaxfilter">
            ...
            <?php
                $cnt = 0;
                $count = count($theSeven);
                foreach ($theSeven as $v) {
                    $cnt ++;
