...
<!--                            </div>-->
                    ...
                    <tr>
                        <td class="" colspan="2">
                            <p class="amc-text-label amc-tt-latolatin-semibold m-0 amc-lineheight-fs32 pt-50"><?= Yii::$app->params['questions_form']['countriesToVisit'][0] ?> <span class="amc-color-e75925"><?= Yii::$app->params['questions_form']['countriesToVisit'][2] ?></span></p>
                            <p class="m-0 amc-color-949494 amc-lineheight-fs32 mt-10"><?= Yii::$app->params['questions_form']['countriesToVisit'][1] ?></p>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2" class="check-step-1">
                    ...
                    <tr>
                        <td class="" colspan="2">
                            <p class="amc-text-label amc-tt-latolatin-semibold m-0 amc-lineheight-fs32 pt-25"><?= Yii::$app->params['questions_form']['deretourDate'][0] ?></p>
                            <p class="m-0 amc-color-949494 amc-lineheight-fs32 mt-10"><?= Yii::$app->params['questions_form']['deretourDate'][1] ?></p>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2" class="amc-fix-arrow">
                            <?= $form->field($model, 'deretourDate', ['inputOptions' => ['class' => 'input_small input-deretourDate', 'placeholder' => 'Choisissez la date', 'data-clear-btn' => "false", 'readonly' => 'readonly', 'data-role' => 'date']]) ?> </div>
                    ...
                    <tr>
                        <td class="" colspan="2">
                            <p style="padding-top: 1rem;" class="amc-text-label amc-tt-latolatin-semibold m-0 pt-25"><?= Yii::$app->params['questions_form']['howTicket'][0] ?></p>
                        </td>

                    </tr>
                    <tr>
                        <td colspan="2"><?=$form->field($model, 'howTicket')->radioList(['Oui' => 'Oui', 'Non mais je souhaite être accompagné pour l’achat de mes billets'=>'Non mais je souhaite être accompagné pour l’achat de mes billets', 'Non' => 'Non'])?></td>
                    </tr>                   
                    <tr class="ticketDetail ticket-plus" style="display: none">
                        <td colspan="2">
                            <p style="padding-top: 1rem;" class="amc-text-label amc-tt-latolatin-semibold m-0 pt-25"><?= Yii::$app->params['questions_form']['ticketDetail'][0] ?></p>
                        </td>

                    </tr>
                    <tr class="ticketDetail ticket-plus" style="display: none">
                        <td colspan="2">
                                    <?=$form->field($model, 'ticketDetail', ['inputOptions'=>['class'=>'input_full', 'rows'=>4, 'style'=>'height: 5.2rem;']])->textArea();?>  
                        </td>
                    </tr>
        ...
        <div id="step-2" class="steps step-2">
            <div class="field-form">
                <table id="tbl-form-tour" class="tbl-form">
                    ...
                    <tr>
                        <td class="" colspan="2">
                            <p style="padding-top: 1rem;" class="amc-text-label amc-tt-latolatin-semibold m-0 pt-25"><?= Yii::$app->params['questions_form']['hotelTypes'][0] ?></p>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
...
<!--                    <tr>
                    ...
                    <tr>
                        <td class="" colspan="2">
                            <p style="padding-top: 1rem;" class="amc-text-label amc-tt-latolatin-semibold m-0 pt-25"><?= Yii::$app->params['questions_form']['desSites'][0] ?></p>
                        </td>
                    </tr>
                    
                    <tr>
                        <td colspan="2" class="">
                            <?= $form->field($model, 'desSites', [
                                'inputOptions' => ['class' => 'input_full', 'rows' => 3, 'style'=>'height: 52px;'],
                            ])->textArea()
                            ?>
                        </td>
                    </tr>
                    <tr>
                        <td class="" colspan="2">
                            <p style="padding-top: 1rem;" class="amc-text-label amc-tt-latolatin-semibold m-0 pt-25"><?= Yii::$app->params['questions_form']['mealsIncluded'][0] ?></p>
                    ...
                    <tr>
                        <td class="" colspan="2">
                            <p style="padding-top: 2rem;" class="amc-text-label amc-tt-latolatin-semibold m-0 pt-25"><?= Yii::$app->params['questions_form']['de_liberte'][0] ?></p>
                        </td>
                    </tr>
                        ...
                        <td colspan="2" class="">
                            <div class="">
                                <?=$form->field($model, 'howMessage', [
                                 'inputOptions'=>['class'=>'input_full amc-count-characters', 'maxlength'=>1000, 'rows'=>6,'style'=>'height: 96px;'],
                                 ])->textArea()?>
                            </div>
                            <div class="text-count-down">
        ...
        <div id="step-3" class="steps step-3">
            <div class="field-form">
                <table id="tbl-form-tour" class="tbl-form">
                    ...
                    <tr>
                        <td class="" colspan="2">
                             <p class="amc-text-label amc-tt-latolatin-semibold m-0 amc-lineheight-fs32 pt-25"><?= Yii::$app->params['questions_form']['fname'][0] ?> <span class="amc-color-e75925"><?= Yii::$app->params['questions_form']['fname'][2] ?></span></p>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                    ...
                    <tr>
                        <td class="" colspan="2">
                             <p class="amc-text-label amc-tt-latolatin-semibold m-0 amc-lineheight-fs32 pt-25"><?= Yii::$app->params['questions_form']['lname'][0] ?> <span class="amc-color-e75925"><?= Yii::$app->params['questions_form']['lname'][2] ?></span></p>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
