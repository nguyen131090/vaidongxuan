<?php $this->registerCssFile(DIR . 'assets/css/page2016/fran-co-phonie.css', ['depends' => 'app\assets\AppAsset', 'position' => $this::POS_END]) ?>
...
<!--        <div class="breadcrumb fix-breadcrumb">
            ...
            <div class="item">
            <span><span>Francophonie</span></span>
            </div>
        </div>-->
    </div>   
...
<div class="contain container-2">
    <div class="amc-column entry-body">
        <div class="amc-row amc-row-1">
            ...
            <img alt="" data-src="<?= $theEntry->photosArray['custom'][0]->image ?>">
...
<!--            <div class="amc-col-left">
            ...
            <img alt="" data-src="<?=DIR?>assets/img/francophonie/1.png">-->
        </div>
        <div class="amc-row amc-row-2">
            <p>
                <img alt="" data-src="<?= $theEntry->photosArray['custom'][1]->image ?>">
                <br>
                <?= $theEntry->photosArray['custom'][1]->model->caption ?>
            </p>
<!--            <p>
                <img alt="" data-src="<?=DIR?>assets/img/francophonie/2.jpg">
                <br>
...
<!--            <h2>Amica Travel, créateur d’emplois francophones</h2>
        ...
        <div class="amc-row amc-row-4">
            <div class="amc-col-left">
                <p>
                    <img alt="" data-src="<?= $theEntry->photosArray['custom'][2]->image ?>">
                    <br>
                    <?= $theEntry->photosArray['custom'][2]->model->caption ?>
                </p>
<!--                <p>
                    <img alt="" data-src="<?=DIR?>assets/img/francophonie/3.jpg">
                    <br>
                    Lettre à l’encre noir sur le « oui » des autorités coloniales.
                </p>-->
...
<!--                <h2>France Alumni Vietnam, un vivier de jeunes francophones</h2>
            ...
            <div class="amc-col-right">
                <p>
                    <img alt="" data-src="<?= $theEntry->photosArray['custom'][3]->image ?>">
                    <br>
                    <?= $theEntry->photosArray['custom'][3]->model->caption ?>
                </p>
<!--                <p>
                    <img alt="" data-src="<?=DIR?>assets/img/francophonie/4.jpg">
                    <br>
                    Lettre à l’encre noir sur le « oui » des autorités coloniales.
                </p>-->
...
<!--                <h2>L’Ambassade de France au Vietnam, un organe francophone majeur</h2>
            ...
            <div class="amc-col-right">
                <p>
                    <img alt="" data-src="<?= $theEntry->photosArray['custom'][4]->image ?>">
                    <br>
                    <?= $theEntry->photosArray['custom'][4]->model->caption ?>
                </p>
<!--                <p>
                    <img alt="" data-src="<?=DIR?>assets/img/francophonie/5.jpg">
                    <br>
                    Lettre à l’encre noir sur le « oui » des autorités coloniales.
                </p>-->
         ...
         <div class="amc-row amc-row-8">
            <div class="amc-col-left">
                <p>
                    <img alt="" data-src="<?= $theEntry->photosArray['custom'][5]->image ?>">
                    
                </p>
                <p>
                    <img alt="" data-src="<?= $theEntry->photosArray['custom'][6]->image ?>">
                    <br>
                    <?= $theEntry->photosArray['custom'][6]->model->caption ?>
                </p>
<!--                <p>
                    <img alt="" data-src="<?=DIR?>assets/img/francophonie/6.jpg">
                </p>
                <p>
                    <img alt="" data-src="<?=DIR?>assets/img/francophonie/7.jpg">
                    <br>
                    Lettre à l’encre noir sur le « oui » des autorités coloniales.
                </p>-->
            ...
            <div class="amc-col-right">
                <p>
                    <img alt="" data-src="<?= $theEntry->photosArray['custom'][7]->image ?>">
                    <br>
                    <?= $theEntry->photosArray['custom'][7]->model->caption ?>
                </p>
<!--                <p>
                    <img alt="" data-src="<?=DIR?>assets/img/francophonie/8.jpg">
                    <br>
                    Lettre à l’encre noir sur le « oui » des autorités coloniales.
                </p>-->
...
<!--            <h2>Amica Travel avance avec ses partenaires associatifs francophones</h2>
        ...
        <div class="amc-row amc-row-10">
            <div class="amc-col-left">
                 <p>
                    <img alt="" data-src="<?= $theEntry->photosArray['custom'][8]->image ?>">
                    <br>
                    <?= $theEntry->photosArray['custom'][8]->model->caption ?>
                </p>
<!--                <p>
                    <img alt="" data-src="<?=DIR?>assets/img/francophonie/9.jpg">
                    <br>
                    Lettre à l’encre noir sur le « oui » des autorités coloniales.
                </p>-->
