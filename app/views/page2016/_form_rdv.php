...
<tr>
    ...
    <tr class="rdv" >
        <td colspan="2">
         <div class="float-left amc-col amc-col-2 col-xs-12 col-sm-3 col-md-3 col-fix-align fix-error-label">
             <span class="fix-middle-text text-label"> Votre numéro téléphone <span class="violet">*</span></span>
         </div>    
         <div class="float-left amc-col amc-col-2 col-xs-12 col-sm-4 col-md-4">
            <?=$form->field($model, 'countryCallingCode', ['inputOptions' => ['class' => 'input_full fix-arrow']])
            ->dropDownList(ArrayHelper::map($allDialCodes, 'code', 'xcode'), [
                'prompt' => '- Indicatif de pays -',
                ]) ?>
            </div>
            <div class="float-left amc-col amc-col-2 col-xs-12 col-sm-1 col-md-1"></div>
            <div class="float-left amc-col amc-col-2 col-xs-12 col-sm-4 col-md-4">
    ...
    <tr class="rdv" >
        <td colspan="2">
            ...
            <div class="float-left amc-col amc-col-2 col-xs-12 col-sm-9 col-md-9">
               <?=$form->field($model, 'callDate', ['inputOptions'=>['class'=>'input_full datepicker noWeekends']]) ?>
...
//$startDate = new DateTime('tomorrow');
            ...
            <tr class="rdv" >
                <td colspan="2">
                   <div class="float-left amc-col amc-col-2 col-xs-12 col-sm-3 col-md-3 col-fix-align fix-error-label">
                       <span class="fix-middle-text text-label">Heure pour le RDV :</span>
                   </div>
                   <div class="float-left amc-col amc-col-2 col-xs-12 col-sm-5 col-md-5">
     ...
     <tr class="new-rdv">
        <td class="float-left amc-col amc-col-sx-3 col-sm-3 col-md-3 col-lg-3"></td>
        <td class="float-left amc-col amc-col-sx-9 col-sm-9 col-md-9 col-lg-9" style="padding-bottom: 20px;">
     ...
     <tr>
         <td colspan="2">
             <div class="float-left amc-col amc-col-2 col-xs-12 col-sm-3 col-md-3 col-fix-align fix-error-label amica-votre-message">
                 <span class="fix-middle-text text-label" style="height: 58px; line-height: 58px;">Votre message <span class="violet">*</span></span>
             </div>
             <div class="float-left amc-col amc-col-2 col-xs-12 col-sm-9 col-md-9">
