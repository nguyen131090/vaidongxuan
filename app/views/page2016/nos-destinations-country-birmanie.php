        ...
        <div class="mt-txt-60">
            <ul class="tous-slider">
                ...
                <? foreach($tourType->items() as $key=> $value) : ?>
                    ...
                    ?>
                    <div class="item-img  animated" data-animation="<?=$class?>" data-analytics="on" data-analytics-category="country_page" data-analytics-action="cats_section" data-analytics-label="cat_card_<?= $value->model->item_id ?>">
                    <a href="<?=DIR.$value->slug ?>">
                        <? $i = ''; ?>
                            <? if(!empty($value->photosArray['summary'])) : 
                                $img = $value->photosArray['summary'][0];
                                ?>
                             <img width="460" height="<?=$key == 4 ? '587' : '281'?>" alt="<?=$img->description?>" data-src="<?=$img->image?>" class="img-lazy lazyload"/>
                        <? endif; ?>
...
<div class="entry-body-entry container-flud mb-60 responsive-entry-body">     
    ...
    <div class="column pourquoi birmanie mt-0">
        <h2 class="title-pourquoi mt-txt-0 mb-txt-40">Pourquoi nous choisir pour votre voyage au <?= ucwords(SEG1) ?></h2>   
        <p class="text">Depuis son ouverture au tourisme en 2012, la Birmanie n'a de cesse d'améliorer ses infrastructures touristiques pour mieux répondre à tous les profils de voyageurs. Cela étant, de son côté, Amica Travel consacre ses efforts à élargir son réseau de partenaires et de prestataires pour pouvoir vous offrir des voyages 100% sur mesure en Birmanie</p> 
        <div class="detail mt-txt-25">
            <div class="item-detail">
                <img alt="" class="img-lazy" data-src='/assets/img/new-pays/birmanie/pourquoi-1.png'/>
                <span>Voyage sur mesure<br>en <?=SEG1 ?></span>
            </div>
            <div class="item-detail">
                <img alt="" class="img-lazy" data-src='/assets/img/new-pays/birmanie/preparer-item-2.png'/>
                <span>Des experts à<br>votre service</span>
            </div>
            <div class="item-detail">
                <img alt="" class="img-lazy" data-src='/assets/img/new-pays/birmanie/preparer-item-3.png'/>
    ...
    <div class="column preparer-voyage <?=SEG1?> mt-60">
        ...
        <? foreach ($infos as $kif => $if): ?>
             <a class="link-item-preparer" href="<?=DIR.$if->slug; ?>">
        ...
        <a href="https://www.amica-travel.com/birmanie/informations-pratiques" style="color: #e35429;" class="btn-amica-basic btn-amica-basic-1 mt-txt-40 mb-0" data-analytics="on" data-analytics-category="country_page" data-analytics-action="info_section" data-analytics-label="cta_c_infos">Voir toutes nos informations pratiques sur la Birmanie</a>
        <div class="btn-preparer mt-60">
            <div>
                ...
                <?= \yii\helpers\Html::dropDownList('search_destination', null, $optDes,[
                        'class' => 'chosen',
                        'multiple' => 'multiple', 
                        'data-placeholder' => 'Tapez le nom d’un site (Bagan, Yagon...)',
    ...
    <div class="container-flud fluid-testi mt-60">
        <div class="column row container">
            <div class="col-12 col-sm-12 col-lg-4 pr-25 pl-0">
                ...
                <div class="text-col-left"><?= isset($testiModule->model->summary) ? $testiModule->model->summary : '' ?></div>
            </div>
...
$css = <<<CSS
    ...
    .tous-slider li.slider-2 .item-img:nth-of-type(3){
        margin-right: 0;
        float: right: 
    }
    .pourquoi .btn-pourquoi{
        background: url('/assets/img/new-pays/birmanie/bg-48h.png') left top no-repeat transparent;
        width: 100%;
        height: 80px;
    }
    .pourquoi .btn-pourquoi span{
        font: 15.5px LatoLatin-Bold,sans-serif;
        color: #1a1a1a;
        margin-right: 90px;
    }
    .pourquoi .btn-pourquoi a{
        font: 15.5px LatoLatin-Bold,sans-serif;
...
.container-flud .pourquoi img{
    background: none;
}
.pourquoi .btn-pourquoi a:hover{
    opacity: 0.7;
}
CSS;
