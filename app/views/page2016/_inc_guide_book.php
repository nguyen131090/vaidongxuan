<? $this->registerCssFile(DIR . 'assets/css/page2016/inc_guide_book.css',['depends' => 'app\assets\AppAsset', 'position' => $this::POS_HEAD]); ?>
<?
...
?>
<div class="contain container-button-guide-book mt-0">
    <div class="amc-column">
        <?
        //var_dump($theEntry->photosArray['custom'][0]);exit;
        ?>
        <div class="area-guide-book d-flex justify-content-center" data-src="<?//= isset($theEntry->photosArray['custom']) ? $theEntry->photosArray['custom'][0]->image : '' ?>">
            <div class="img-book">
            ...
            <div class="right-guide">
                ...
                <form id="download-guide-form-new">
                    ...
                    <label class="form-check-label float-left mt-25" for="exampleCheck1">
                        <input type="checkbox" class="form-checkbox-input float-left d-none" id="exampleCheck1">
                        <span class="amc-checkbox"></span>
                    ...
                    <button type="submit" class="submit-email btn-amica-basic btn-amica-basic-2" data-analytics="on" data-analytics-category="<?= $category ?>" data-analytics-action="pdf_section" data-analytics-label="btn_download">Télécharger</button>
                </form>
            </div>
        </div>    
    </div>
