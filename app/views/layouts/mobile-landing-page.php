            ...
            <nav style="" class="navbar navbar-default navbar-fixed-top">
                ...
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        <ul class="btn-header">
                            <li class="logo"><a class="" href="<?=DIR?>" data-ajax="false"><img alt="Amica Travel" data-src="<?= DIR ?>assets/img/mobile/logo-amica.png" data-analytics="on" data-analytics-category="landing_page" data-analytics-action="cover_section" data-analytics-label="logo_amica"></a></li>
...
<!--                            <li class="navigation"> 
                            ...
                            <li class="search">
                                <a href="#infomation" aria-label="Information" data-transition="slidedown" data-direction="" class="btn-testi" data-analytics="on" data-analytics-category="landing_page" data-analytics-action="cover_section" data-analytics-label="icon_infobox">
...
<!-- end test lazy image -->
<div class="rows row-footer" data-role="none" style="padding-bottom: 4rem;">
