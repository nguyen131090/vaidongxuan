...
$data = array(
    ...
    'devis_guest' => '<span style="font-family:Candara;color:black;font-size: 11pt;font-weight:bold;">'.$_POST['devis_guest'].'</span>',
    'devis_date' => '<span style="font-family:Candara;color:black;font-size: 10pt;font-weight:bold;">'.$_POST['devis_date'].'</span>',
...
//$docx->addTemplate($webRoot.'/helpers/template/devis/' . $data['template'] . '.docx');
$docx->replaceTemplateVariableByHTML('devis_name', 'block', "<span style='color: $color_devis_name;font-weight: bold;font-size:22pt;margin:0; padding: 0;'>" .  $data['devis_name'] . "</span>");
