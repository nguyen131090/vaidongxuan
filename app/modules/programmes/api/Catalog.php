...
use app\modules\programmes\models\ItemData;
...
/**
 * Catalog module API
 * @package app\modules\programmes\api
 *
...
class Catalog extends \yii\easyii\components\API
{
    ...
    'app_programmes_items.*', 
    new \yii\db\Expression('IF(on_top IS NULL OR on_top="0", 1, 0) AS on_top_flag, JSON_EXTRACT(app_programmes_items.data, "$.budget") AS budget')
])->joinWith('category')->with(['seo', 'category'])->andWhere(['app_programmes_items.status' => 1]);
