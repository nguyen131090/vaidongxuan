...
use yii\easyii\components\ItemController;
...
class ItemsController extends ItemController
{
            ...
            if(Yii::$app->request->isAjax){
                ...
                if (isset($_FILES) && $this->module->settings['itemThumb']) {
                    ...
                    if ($model->image && $model->validate(['image'])) {
                        $model->image = Image::upload($model->image, 'programmes');
                    } else {
                        $model->image = '';
                    }
                }
        ...
        foreach($fields as $field)
        {
            ...
            elseif ($field->type === 'selectTags') {
                ...
                $result .= '<div class="control-group">
                   ...
                   <select id="list-exts-'.$field->name.'" data-type = "'.$field->name.'" name="'."Data[{$field->name}][]".'" multiple class="form-control selectTags">'. Html::renderSelectOptions($value, $options) .'</select>
                </div>';
             ...
             elseif ($field->type === 'selectLocations') {
                ...
                $result .= '<div class="control-group">
                    <label for="select-beast">'.$field->title.'</label>
                   <select id="list-exts-'.$field->name.'" data-type = "'.$field->name.'" name="'."Data[{$field->name}][]".'" multiple class="form-control selectTags">'. Html::renderSelectOptions($value, $locations) .'</select>
                </div>';
                $result .= '<input style="display: none;" id="exts-order-'.$field->name.'" name="exts-order['.$field->name.']" />';
            ...
            elseif ($field->type === 'countries') {
                ...
                $result .= '<div class="control-group">
                    <label for="select-beast">'.$field->title.'</label>
                   <select id="list-exts-'.$field->name.'" data-type = "'.$field->name.'" name="'."Data[{$field->name}][]".'" multiple class="form-control selectTags">'. Html::renderSelectOptions($value, $countries) .'</select>
                </div>';
                $result .= '<input style="display: none;" id="exts-order-'.$field->name.'" name="exts-order['.$field->name.']" />';
            ...
            elseif ($field->type === 'modulepage') {
                ...
                $result .= '<div class="control-group">
                    <label for="select-beast">'.$field->title.'</label>
                   <select id="list-exts-'.$field->name.'" data-type = "'.$field->name.'" name="'."Data[{$field->name}][]".'" multiple class="form-control selectTags">'. Html::renderSelectOptions($value, $this->getModulePage()) .'</select>
                </div>';
                $result .= '<input style="display: none;" id="exts-order-'.$field->name.'" name="exts-order['.$field->name.']" />';
           ...
           elseif ($field->type === 'file') {
            ...
            elseif ($field->type === 'destinations') {
                ...
                $result .= '<div class="control-group">
                    <label for="select-beast">'.$field->title.'</label>
                   <select id="list-exts-'.$field->name.'" data-type = "'.$field->name.'" name="'."Data[{$field->name}][]".'" multiple class="form-control selectTags">'. Html::renderSelectOptions($value, $destinations) .'</select>
                </div>';
                $result .= '<input style="display: none;" id="exts-order-'.$field->name.'" name="exts-order['.$field->name.']" />';
            ...
            elseif (in_array($field->type, ['tourTypes', 'tTourThemes', 'tTourJours'])) {
                ...
                $result .= '<div class="form-group"><label>'. $field->title .'</label><select name="Data['.$field->name.']" class="form-control">'. Html::renderSelectOptions($value, $options) .'</select></div>';
            } elseif ($field->type === 'cattour') {
                $catTour = ArrayHelper::map(\app\modules\programmes\api\Catalog::cats(), 'category_id', 'title');
                $result .= '<div class="control-group">
                    <label for="select-beast">'.$field->title.'</label>
                   <select id="list-exts-'.$field->name.'" data-type = "'.$field->name.'" name="'."Data[{$field->name}][]".'" multiple class="form-control selectTags">'. Html::renderSelectOptions($value, $catTour) .'</select>
                </div>';
                $result .= '<input style="display: none;" id="exts-order-'.$field->name.'" name="exts-order['.$field->name.']" />';

            } elseif ($field->type === 'programes') {
                $result .= '<div class="control-group">
                    <label for="select-beast">'.$field->title.'</label>
                   <select id="list-exts-'.$field->name.'" data-type = "'.$field->name.'" name="'."Data[{$field->name}][]".'" multiple class="form-control selectTags">'. Html::renderSelectOptions($value, $this->getTours()) .'</select></div>';
                $result .= '<input style="display: none;" id="exts-order-'.$field->name.'" name="exts-order['.$field->name.']" />';
