<?php
namespace app\modules\widgets\api;

use Yii;
use yii\easyii\components\API;
use yii\easyii\helpers\Data;
use yii\helpers\Url;
use app\modules\widgets\models\Text as TextModel;
use yii\helpers\Html;

/**
 * Text module API
 * @package app\modules\widgets\api
 *
...
class Text extends API
{
    ...
    public function api_get($id_slug)
    {
        ...
        return LIVE_EDIT ? API::liveEdit($text['widgets'], Url::to(['/admin/text/a/edit/', 'id' => $text['text_id']])) : $text['widgets'];
    }
    ...
    private function notFound($id_slug)
    {
        ...
        if(!Yii::$app->user->isGuest && preg_match(TextModel::$SLUG_PATTERN, $id_slug)){
            $text = Html::a(Yii::t('easyii/widgets/api', 'Create text'), ['/admin/text/a/create', 'slug' => $id_slug], ['target' => '_blank']);
        }
