...

{
...

    {
        ...
        return [
            ...
            [['description','slug', 'summary', 'spirit', 'summary_title'], 'safe'],
...

    {
        ...
        return [
            ...
            'available' => Yii::t('easyii/destinations', 'Available'),

            'price' => Yii::t('easyii/destinations', 'Price'),

            'discount' => Yii::t('easyii/destinations', 'Discount'),
...

    {
        ...
        return $this->hasMany(Photo::className(), ['item_id' => 'item_id'])->where(['class' => self::className()])->desc();
