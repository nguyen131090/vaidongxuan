...

{
    ...
    public function rules(){
        return array_merge(parent::rules(), [
            [['summary','sub_title','summary_title','on_top', 'data', 'fields_category'], 'safe']
            ]);
    ...
    public function getItems(){
        if(SEG1 == 'admin'){
         return $this->hasMany(Item::className(), ['category_id' => 'category_id'])->sortDate();
            ...
            return $this->hasMany(Item::className(), ['category_id' => 'category_id'])->status(Item::STATUS_ON)->sortDate();
    }
