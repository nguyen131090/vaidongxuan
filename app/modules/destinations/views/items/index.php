...
$this->title = Yii::t('easyii/destinations', 'Catalog');
            ...
            <tr data-id="<?= $item->primaryKey ?>">
                ...
                <td class="text-right">
                    <div class="btn-group btn-group-sm" role="group">
                        ...
                        <a href="<?= Url::to(['/admin/'.$module.'/items/top', 'id' => $item->primaryKey]) ?>" class="btn btn-default" title="Top"><span class="glyphicon glyphicon glyphicon-chevron-up"></span></a>
