...

{
...

    {
        return array_merge(parent::rules(), [
           [['description','slug', 'summary', 'programes', 'spirit', 'on_projet', 'sub_title'], 'safe'],
...

    {
        ...
        return [
            ...
            'available' => Yii::t('easyii/exclusives', 'Available'),

            'price' => Yii::t('easyii/exclusives', 'Price'),

            'discount' => Yii::t('easyii/exclusives', 'Discount'),
