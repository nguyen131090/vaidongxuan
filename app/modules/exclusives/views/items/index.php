...
$this->title = Yii::t('easyii/exclusives', 'Catalog');
...
<?php if(count($model->items)) : ?>
    <table class="table table-hover">
        ...
        <tr>
            ...
            <th width="60"><?= Yii::t('easyii', 'Status') ?></th>
            <th width="190"></th>
        </tr>
        </thead>
        <tbody>
            ...
            <tr data-id="<?= $item->primaryKey ?>">
                ...
                <td class="text-right">
                    <div class="btn-group btn-group-sm" role="group">
                        ...
                        <a href="<?= Url::to(['/admin/'.$module.'/items/top', 'id' => $item->primaryKey]) ?>" class="btn btn-default" title="Move to top"><span class="glyphicon glyphicon glyphicon-chevron-up"></span></a>
                        <a href="<?= Url::to(['/admin/'.$module.'/items/end', 'id' => $item->primaryKey]) ?>" class="btn btn-default" title="Move to end"><span class="glyphicon glyphicon glyphicon-chevron-down"></span></a>
