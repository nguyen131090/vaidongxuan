...
<?php if(IS_ROOT) : ?>
    <ul class="nav nav-tabs">
        ...
        <li <?= ($action === 'fields-category') ? 'class="active"' : '' ?>><a href="<?= Url::to(['/admin/'.$module.'/a/fields-category', 'id' => $model->primaryKey]) ?>"><span class="glyphicon glyphicon-cog"></span> Fields Category</a></li>
