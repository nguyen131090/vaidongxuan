...
{
    public $categoryClass = 'app\modules\exclusives\models\Category';
    public $moduleName = 'exclusives';
    ...
    public function actionFields($id)
    {
        ...
        if (Yii::$app->request->post('save'))
        {
            ...
            if($model->save()){
                ...
                $this->flash('success', Yii::t('easyii/exclusives', 'Category updated'));
            }
            else{
