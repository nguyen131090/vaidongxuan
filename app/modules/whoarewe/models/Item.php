...

{
...

    {
        return array_merge(parent::rules(), [
           [['description','slug', 'summary', 'sub_title'], 'safe'],
...

    {
        ...
        return [
            ...
            'available' => Yii::t('easyii/whoarewe', 'Available'),

            'price' => Yii::t('easyii/whoarewe', 'Price'),

            'discount' => Yii::t('easyii/whoarewe', 'Discount'),
