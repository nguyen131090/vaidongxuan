...
class DevisPersionalFormMobile extends Model {
    ...
    public function rules() {
        return [
           ...
           // [['tourThemes'],'required','on'=>['devis_mobile', 'mobileBooking', 'mobile_contact_booking']],
            ...
            [['email'], 'email'],
            [['prefix', 'fullName', 'email','numberOfTravelers18', 'lname', 'fname', 'telephone'], 'required', 'message' => '{attribute} ne peut être vide.'],
...
//                    }",'tooSmall' => 'Nombre des participants requis'],                      
    ...
    public function scenarios() {
        return [
            ...
            'mobile_contact_booking' => ['typeGo', 'numberOfTravelers18', 'numberOfTravelers12', 'numberOfTravelers2', 'interest', 'phone', 'email', 'age', 'message', 'has_date', 'tourLength', 'tourThemes', 'contactPhone', 'departureDate', 'agesOfTravelers12','hotelRoomDbl', 'hotelRoomTwn','hotelRoomTrp','hotelRoomSgl','budget', 'whyCountry', 'howTraveler', 'premierVoyage', 'howMessage', 'howHobby', 'contactEmail', 'howTicket', 'ticketDetail', 'job', 'lepetit', 'lepetit', 'region', 'ville', 'numberOfTravelers0', 'reference','newsletter', 'country', 'vouspartez', 'hotelTypes', 'mealsIncluded', 'de_liberte', 'lname', 'fname', 'telephone', 'prefix','desSites', 'deretourDate','dialcodeCountry', 'duraTime', 'pourCeProjet', 'budgetPlafond'],
