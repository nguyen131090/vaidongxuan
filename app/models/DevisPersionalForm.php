...
class DevisPersionalForm extends Model
{
...
[['mealsIncluded'],'required', 'message' => 'Le rythme ne peut pas être vide.' ,'on'=>['devis_long']],    
[['de_liberte'],'required', 'message' => 'Le degré de liberté ne peut pas être vide.' ,'on'=>['devis_long']],  
[['des_devis'],'required', 'message' => 'La question sur les autres agences ne peut pas être vide.' ,'on'=>['devis_long']],
[['se_baseront'],'required', 'message' => 'Les critères de décision ne peut pas être vide.' ,'on'=>['devis_long']], 
[['hotelTypes'],'required', 'message' => 'Le type d’hébergement ne peut pas être vide.' ,'on'=>['devis_long']],                          
...
//			[['numberOfTravelers18'], 'number', 'integerOnly'=>true, 'min'=>1, 'tooSmall'=>'Nombre des participants requis'],   
	 ...
	 public function scenarios()
    {
        ...
        'contact_booking'=> ['tourName', 'tourUrl','prefix', 'fname', 'lname', 'email', 'country', 'region', 'ville', 'departureDate', 'numberOfTravelers18', 'agesOfTravelers12', 'numberOfTravelers12', 'numberOfTravelers2', 'tourLength', 'tourThemes',
        'numberOfTravelers0',
        'message',
        'budget',
        'hotelTypes',
