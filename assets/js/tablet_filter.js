...
$('.btn-bottom-fixed-tablet .btn-bottom-search').click(function(){
    
    $('html, body').addClass('overlay-lock');
});

$(document).on('click','#tabletFilter .btn-close',function(){
    $('#tabletFilter').removeClass('show');
...
$(document).on('click','#search-page-voyage .reset-filter', function(){
  $(this).parent().removeClass('active');  
  var pr = $(this).data('get');
  var url_1 = window.location.pathname;
