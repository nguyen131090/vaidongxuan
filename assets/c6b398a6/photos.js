$(function(){
    ...
    photosBody.on('input propertychange', '.photo-caption', function(){
        var saveBtn = $(this).closest('tr').find('.save-photo-description');
        if(saveBtn.hasClass('disabled')){
            saveBtn.removeClass('disabled').on('click', function(e){
                ...
                var caption = tr.find('.photo-caption').val();
                var type = tr.find('.photo-type').val();
                $.post(
                    $this.attr('href'),
                    {description: text, caption: caption, type: type},
                    function(response){
                        if(response.result === 'success'){
    ...
    photosBody.on('input propertychange', '.photo-type', function(){
        var saveBtn = $(this).closest('tr').find('.save-photo-description');
        if(saveBtn.hasClass('disabled')){
            saveBtn.removeClass('disabled').on('click', function(e){
                e.preventDefault();
