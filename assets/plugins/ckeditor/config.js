...
CKEDITOR.editorConfig = function( config ) {
	...
	config.toolbarGroups = [
		...
		{ name: 'forms' },
		{ name: 'tools' },
		{ name: 'document',	   groups: [ 'mode', 'document', 'doctools', 'alignment' ] },
